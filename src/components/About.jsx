		...
		<div className="w-full bg-zinc-900">
			<div className="max-w-[1240px] mx-auto pb-60">
				<div className="text-center">
					<h2 className="text-5xl font-bold py-6 pt-48 text-white">About me</h2>
				</div>
				<div className="flex flex-row items-center shadow-xl bg-white rounded-2xl my-5 ">
					<img
				...
				<div className="grid md:grid-cols-3 gap-7 px-2 py-4 text-center ">
					<div className=" py-8 rounded-xl shadow-xl  bg-zinc-600">
				...
				<div className="flex flex-col items-center   bg-neutral-800 rounded-2xl my-5 ">
